          ...
          <div class="col-12">
			  ...
			  <table class="table table-head-fixed text-nowrap" id="user_data">
					<thead>
						<tr>
							...
							<th width="45%" style="padding: 6px 0px 10px 24px;">COMPANY NAME</th>
							<th width="16%">CITY</th>
            ...
            $dbname = "ticket";
					...
					<tr>
						...
						<td><button id="myBtnx" name="<?php echo $row['company'];?>" class="btn" data-modal="myModalx"><?php echo $row['company'];?></button></td>
						<td><?php echo $row['city'];?></td>
                        <td><?php echo $row["State/Territory"];?></td>
